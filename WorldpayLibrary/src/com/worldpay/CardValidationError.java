 ...
 * 
 * <ul>
 * <li>To check if the card contains any error : {@link CardValidationError#hasErrors()}<br>
 * </li>
 ...
 * </ul>
 * <p>
 * {@link Card#validate()} returns this class in order to specify validation errors. An example: <br>
 * 
 * <pre>
 * 
 ...
 * 		//something is wrong with the expiry date 
 * 	}
